...
const fixtureFile = (file) => path.join(fixtureDir, file);
const fixtureFiles = (0, fs_1.readdirSync)(fixtureDir);
const readFixture = async (file) => {
    const data = await fs_1.promises.readFile(fixtureFile(`${file}.yaml`), 'utf-8');
    const chunks = data.split("\n---\n");
    const before = chunks[0].trim();
    const operations = (0, yaml_1.parse)(chunks[1].trim()).patch;
    const after = chunks[2].trim();
    return { before, after, operations };
};
const yamlTrim = (yaml) => yaml.trim() + "\n";
describe("yaml-patch", () => {
    describe("fixtures", () => {
        for (const file of fixtureFiles) {
            ...
            it(name, async () => {
                ...
                const result = (0, index_1.yamlPatch)(before, operations);
    ...
    describe("various", () => {
        ...
        it("add scalar (null)", () => {
            const res = (0, index_1.yamlPatch)(`a: null`, [
                {
                    op: 'add',
                    path: '/b',
                    value: null,
        ...
        it("add string with slash in key", () => {
            const res = (0, index_1.yamlPatch)(`a: String a`, [
                {
                    op: 'add',
                    path: '/b~1b',
                    value: 'String b/b',
    ...
    describe("errors", () => {
        it("reference non-existing path", () => {
            const thrower = () => (0, index_1.yamlPatch)(`a: b`, [
                {
                    op: 'add',
                    path: '/foo/bar',
                    value: 'baz',
        ...
        it("reference inside null", () => {
            const thrower = () => (0, index_1.yamlPatch)(`foo: null`, [
                {
                    op: 'add',
                    path: '/foo/bar',
                    value: 'baz',
        ...
        it("add invalid type", () => {
            const thrower = () => (0, index_1.yamlPatch)(`a: null`, [
                {
                    op: 'add',
                    path: '/b',
                    value: [
        ...
        it("invalid array indexing (negative)", () => {
            const thrower = () => (0, index_1.yamlPatch)(`a: [ 42 ]`, [
                {
                    op: 'remove',
                    path: '/a/-1',
                }
    ...
    describe("keeping whitespace & structure", () => {
        it("add to multi-line object keeps multi-line", () => {
            const result = (0, index_1.yamlPatch)(`a:\n  b: c\n`, [
                {
                    op: 'add',
                    path: '/a/x',
                    value: 'y',
        ...
        it("add to single-line object keeps single-line", () => {
            const result = (0, index_1.yamlPatch)(`a: { b: c }\n`, [
                {
                    op: 'add',
                    path: '/a/x',
                    value: 'y',
        ...
        it.skip("keep long lines of text", () => {
            ...
            const result = (0, index_1.yamlPatch)(`a: ${line}\n`, []);
