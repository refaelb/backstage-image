...
exports.OperationReplyAddressInfo = exports.OperationChannelInfo = exports.OperationReplyInfo = exports.OperationInfo = exports.Operation = void 0;
                        ...
                        react_1.default.createElement("div", { className: "p-4" },
                            ...
                            react_1.default.createElement("div", { className: "mt-2" },
                                ...
                                explicitChannel && (react_1.default.createElement("div", { className: "w-full mt-4 ".concat(showChannel ? 'block' : 'hidden') },
                                    react_1.default.createElement(exports.OperationChannelInfo, __assign({}, props)),
                                    ' '))))),
...
var OperationChannelInfo = function (_a) {
    var _b = _a.type, type = _b === void 0 ? types_1.PayloadType.SEND : _b, channelName = _a.channelName, channel = _a.channel;
    var config = (0, contexts_1.useConfig)();
    var servers = typeof channel.servers === 'function' && channel.servers().all();
    var parameters = channel.parameters() !== undefined
        ? helpers_1.SchemaHelpers.parametersToSchema(channel.parameters())
...
exports.OperationChannelInfo = OperationChannelInfo;
