...
function updateWorkspaceConfiguration(tree, workspaceConfig) {
    const { 
    // Nx Json Properties
    cli, defaultProject, generators, implicitDependencies, plugins, pluginsConfig, npmScope, namedInputs, targetDefaults, workspaceLayout, tasksRunnerOptions, affected, extends: ext, installation, release, } = workspaceConfig;
    const nxJson = {
